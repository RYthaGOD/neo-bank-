...
interface EvmWallet {
    ...
    _signTypedData?: (domain: Record<string, any>, types: Record<string, any>, message: Record<string, any>) => Promise<string>;
}
...
declare class SolanaAgentKit<TPlugins = Record<string, never>> {
    ...
    methods: TPlugins;
    actions: Action$1[];
    constructor(wallet: BaseWallet, rpc_url: string, config: Config, evmWallet?: EvmWallet);
    /**
...
declare function createOpenAITools(solanaAgentKit: SolanaAgentKit, actions: Action[]): Tool[];
...
export { type Action$1 as Action, type ActionExample$1 as ActionExample, type BaseWallet, type Config, type EvmWallet, type FetchPriceResponse, type Handler$1 as Handler, type HeliusWebhookIdResponse, type HeliusWebhookResponse, KeypairWallet, type LuloAccountDetailsResponse, type Plugin, type PriorityFeeResponse, type PumpFunTokenOptions, type PumpfunLaunchResponse, type PythFetchPriceResponse, type PythPriceFeedIDItem, type PythPriceItem, SolanaAgentKit, type TokenCheck, createLangchainTools, createOpenAITools, createSolanaTools as createVercelAITools, executeAction, feeTiers, getActionExamples, getComputeBudgetInstructions, getMintInfo, isVersionedTransaction, sendTx, signOrSendTX };
